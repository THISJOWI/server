package uk.thisjowi.Authentication.kafka;
...
import uk.thisjowi.Authentication.dto.UserRegisteredEvent;
...
public class KafkaProducerService {
    ...
    public void sendUserRegisteredEvent(User user) {
        try {
            ...
            logger.info("User registered event sent to Kafka: userId={}, username={}", 

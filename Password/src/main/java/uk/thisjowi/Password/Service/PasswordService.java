package uk.thisjowi.Password.Service;

import lombok.AllArgsConstructor;
import org.springframework.stereotype.Service;
import uk.thisjowi.Password.Entity.Password;
import uk.thisjowi.Password.Repository.PasswordRepository;
import uk.thisjowi.Password.Utils.Encryption;
import uk.thisjowi.Password.Utils.JwtUtil;
...
public class PasswordService {
    ...
    public Password updatePasswordByToken(String authHeader, Long id, Password passwordData) {
        ...
        // Update and encrypt username field
        if (passwordData.getUsername() != null && !passwordData.getUsername().trim().isEmpty()) {
            existing.setUsername(encryption.encrypt(passwordData.getUsername().trim()));
        }

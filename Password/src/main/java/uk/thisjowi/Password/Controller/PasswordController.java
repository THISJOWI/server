package uk.thisjowi.Password.Controller;
...
import uk.thisjowi.Password.Entity.PasswordDTO;
import uk.thisjowi.Password.Service.PasswordService;
...
public class PasswordController {
    ...
    public ResponseEntity<?> createPassword(
        ...
        try {
            ...
            if (passwordDTO.getUsername() == null || passwordDTO.getUsername().trim().isEmpty()) {
                return ResponseEntity.badRequest()
